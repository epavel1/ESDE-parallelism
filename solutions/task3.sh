...
#SBATCH --output=job_output_task3_%j.log  # Output file (%j is replaced by the job ID)
#SBATCH --error=job_error_task3_%j.log    # Error file (%j is replaced by the job ID)
